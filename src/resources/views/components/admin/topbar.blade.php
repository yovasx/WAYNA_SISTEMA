<header class="sticky top-0 z-50 border-b border-[#d8d2de] bg-[#fdf8ff]/95 backdrop-blur">
    <div class="mx-auto flex h-16 max-w-[1600px] items-center justify-between px-4 sm:px-6 lg:px-8">
        <div class="flex items-center gap-3">
            <button type="button" @click="openMobileSidebar()" class="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-[#d8d2de] bg-white text-slate-600 transition hover:border-[#5f4cae] hover:text-[#5f4cae] md:hidden" aria-label="Abrir menu">
